...
class opts(object):
  def __init__(self):
    ...
    self.parser.add_argument('task', default='1', help='saving task name')
    self.parser.add_argument('--img_folder', default='../train_images/')
    self.parser.add_argument('--ano_folder', default='../train_annotations/')
